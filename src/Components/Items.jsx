    ...
    <div className="flex justify-center w-full my-10 ">
      <div className="w-[60vw] h-[90vh] flex gap-[2rem] ">
        <div className="w-1/3 h-[100%] flex flex-col gap-[2rem] ">
          <Link to={"/Shop"} className="w-full h-[60%] cardsImage1 flex items-baseline-last justify-center pb-5 ">
          ...
          <Link to={"/Shop"} className="w-full h-[40%] cardsImage4 flex items-baseline-last justify-center pb-5 ">
        ...
        <div className="w-1/3 h-[100%] flex flex-col gap-[2rem] ">
          <Link to={"/Shop"} className="w-full h-[40%] cardsImage2 flex items-baseline-last justify-center pb-5 ">
          ...
          <Link to={"/Shop"} className="w-full h-[60%] cardsImage5 flex items-baseline-last justify-center pb-5 ">
        ...
        <div className="w-1/3 h-[100%] flex flex-col gap-[2rem] ">
          <Link to={"/Shop"} className="w-full h-[60%] cardsImage3 flex items-baseline-last justify-center pb-5 ">
          ...
          <Link to={"/Shop"} className="w-full h-[40%] cardsImage6 flex items-baseline-last justify-center pb-5 ">
